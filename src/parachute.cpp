...
Parachute::Parachute(float x, float y, float z, float vel_x, float vel_z, color_t color) {
    this->position = glm::vec3(x, y, z);
    this->velocity = glm::vec3(vel_x, -1/100.0f, vel_z);
    this->rotation = 0;
    // speed = 1;
    float radius;
    float l;
    ...
    this->object4a = create3DObject(GL_TRIANGLES, k/3, vertex_buffer_data4b, COLOR_BOOMERANG, GL_FILL);
    vertex_buffer_data4b[k++] = 0.0f;
    vertex_buffer_data4b[k++] = l+(l/3.6f);
    vertex_buffer_data4b[k++] = 0.0f;
    this->object4b = create3DObject(GL_LINE_STRIP, k/3, vertex_buffer_data4b, COLOR_BROWN, GL_FILL);
    ...
    this->object2 = create3DObject(GL_TRIANGLES, k/3, vertex_buffer_data1, COLOR_BROWN, GL_FILL);
