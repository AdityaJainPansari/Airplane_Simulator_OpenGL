...
* Cockpit View (Pilot's Eye)
  ...
  * It is easy to aim a Missile using this view.
  <img src='./images/cockpit1.png' width=416px alt="Cockpit_View" />
  <img src='./images/cockpit2.png' width=416px alt="Cockpit_View" />
...
* Top View (Bird's Eye)
  ...
  * It is easy to aim a Drop-Bomb using this view.
  ...
  <img src='./images/birds_eye_view_top_view.png' width=416px alt="Top_View" />
* Tower View
  * Here, the camera is sitting on a tower, to the side of the plane of playing, observing it at an angle.
  ...
  <img src='./images/tower_view1.png' width=416px alt="Tower_View" />
  <img src='./images/tower_view2.png' width=416px alt="Tower_View" />
...
* Follow-cam View
  * This is a view of the plane and the region in front of it from a location behind and above it, as if the camera is following the plane.
  ...
  <img src='./images/follow_cam_view1.png' width=416px alt="Follow-cam_View" />
  <img src='./images/follow_cam_view2.png' width=416px alt="Follow-cam_View" />
...
* Fixed-cam View
  * The Camera is fixed at the starting point of the game.
  <img src='./images/fixed_camera1.png' width=416px alt="Fixed-cam_View" />
  <img src='./images/fixed_camera2.png' width=416px alt="Fixed-cam_View" />
